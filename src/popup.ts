/**
 * @file popup.ts
 * @description Handles the interface logic for the Chrome extension popup. 
...
/**
 * Creates single session entry in the popup with a download button.
...
/**
 * Renders list of Panopto sessions in the popup.
 * @param sessions - The list of session data.
 */
